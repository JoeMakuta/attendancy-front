...
import {MdOutlineQrCodeScanner, MdOutlineAdminPanelSettings} from "react-icons/md"
        ...
        return (
          <Link
            ...
            className={`
              ${selectedMenu == elt.name
                ...
                : "hover:bg-main_color/10 "}   px-4 py-2  rounded-md
            `}
            onClick={() => {
          ...
          >
            <li className="flex items-center gap-3">
              {elt.icon({className : ` ${selectedMenu == elt.name ? '' : 'text-main_color'}`})}
            <span>
            {elt.name}
            </span>
            </li>
